...
<div class="container ">
    <div class="row p-0">
        <div class="col-12 p-0 way">
            <p class="way ml-4 p-0 my-2"><a href="/">Главная</a> / <a href="/admin">Товаровед</a> / <span>Редактирование существующей категории товаров</span></p>
        </div>
        <div class="col-12 p-0 goods_type delivery">
            <h2 class="ml-4 mb-0">Товаровед</h2>
            <p>Редактирование существующей категории товаров. Поля, отмеченные звездочками, обязательны для заполнения</p>
            <br>
            {{editCathegoryForm}}
            <br><br>
        </div>

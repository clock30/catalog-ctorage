...
<div class="container ">
    <div class="row p-0">
        <div class="col-12 p-0 way">
            <p class="way ml-4 p-0 my-2"><a href="/">Главная</a> /  <span>Отчеты</span></p>
        </div>
        <div class="col-12 p-0 goods_type delivery">
            <h2 class="ml-4 mb-0">Отчеты</h2>
            <br>
            <ul class="mx-4 admin_actions_list">
                <li><a href="/reports/report1">Остатки товаров на дату</a></li>
                <li><a href="/reports/report2">Движение товара за период</a></li>
            </ul>
            <br><br>
        </div>
    </div>

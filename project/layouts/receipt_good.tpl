...
<div class="container ">
    <div class="row p-0">
        <div class="col-12 p-0 way">
            <p class="way ml-4 p-0 my-2"><a href="/">Главная</a> / <a href="/storage">Склад</a> / <span>Поступление товара</span></p>
        </div>
        <div class="col-12 p-0 goods_type delivery">
            <h2 class="ml-4 mb-0">Склад</h2>
            <p>Поступление товара. Поля, отмеченные звёздочками, обязательны для заполнения</p>
            <br>
            {{ttnRequisites}}
            <br><br>
        </div>

...
<div class="container ">
    <div class="row p-0">
        <div class="col-12 p-0 way">
            <p class="way ml-4 p-0 my-2"><a href="/">Главная</a> / <a href="/admin">Товаровед</a> / <span>Редактирование карточки товара</span></p>
        </div>
        <div class="col-12 p-0 goods_type delivery">
            <h2 class="ml-4 mb-0">Товаровед</h2>
            <p>Выбор карточки товара для редактирования</p>
            <br>
            {{deleteEditGoodSelectForm}}
            <br><br>
        </div>
    </div>
</div>

...
<div class="container ">
    <div class="row p-0">
        <div class="col-12 p-0 way">
            <p class="way ml-4 p-0 my-2"><a href="/">Главная</a> /  <span>Контрагенты</span></p>
        </div>
        <div class="col-12 p-0 goods_type delivery">
            <h2 class="ml-4 mb-0">Контрагенты</h2>
            <br>
            <ul class="mx-4 admin_actions_list">
                <li><a href="/partners/add-partner">Добавление контрагента</a></li>
                <li><a href="/partners/edit-partner">Редактирование контрагента</a></li>
                <li><a href="/partners/delete-partner">Удаление контрагента</a></li>
            </ul>
            <br><br>
        </div>
    </div>

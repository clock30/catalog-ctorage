...
<div class="container ">
    <div class="row p-0">
        <div class="col-12 p-0 way">
            <p class="way ml-4 p-0 my-2"><a href="/">Главная</a> /  <span>Склад</span></p>
        </div>
        <div class="col-12 p-0 goods_type delivery">
            <h2 class="ml-4 mb-0">Склад</h2>
            <br>
            <ul class="mx-4 admin_actions_list">
                <li><a href="/storage/receipt-good">Поступление товара</a></li>
                <li><a href="/storage/edit-receipt-good">Редактирование поступления товара</a></li>
            </ul>
            <br><br>
        </div>
    </div>
